...
* `prototype`: Son propiedades que se comparten entre todas las instancias del constructor. 
* _Constructors_ (de Clases): un constructor es una funcion que crea un nuevo objeto. 
